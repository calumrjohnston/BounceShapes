...
/**
*
* Rect is an rectangle shape that can be drawn to the screen, either filled with
...
public class Rect extends ClosedShape {
	...
	// the width and height of the rectangle, the initials are kept for shrinking
