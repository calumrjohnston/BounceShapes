...
public class ClosedShape {
	...
	/**
	 *  Whether or not the shape is pulsing or not.
	 */
	 ...
	 */
	protected ClosedShape (int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled, boolean pulsing) {
		this.xPos = x;
		this.yPos = y;
		this.xVec = vx;
		this.yVec = vy;
	...
	public void pulse() {
	 	...
	 	System.out.println ("You forgot to override a method! (pulse)");
	 	System.out.println ("Don't modify this method.");
